...
public class HomePage extends MyPage {
	...
	public String createContent(HttpServletRequest request) throws IOException {
		...
		w.e("img", "src", "/Npackd.png", "style", "padding: 1em");
		w.end("a");
		w.end("td");
		w.start("td");
		String html =
				"<a width=\"300\" height=\"300\" class=\"twitter-timeline\" href=\"https://twitter.com/Npackd\" data-widget-id=\"259268267359731712\">Tweets von @Npackd</a>"
