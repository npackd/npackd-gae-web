...
/**
 * Processes all package versions.
 */
public abstract class ForEachPackageVersionAction extends Action {

    /**
     * @param urlRegEx regular expression for URLs. Example: "^/def$"
     * @param st permission to call this action
     */
    public ForEachPackageVersionAction(String urlRegEx, ActionSecurityType st) {
        super(urlRegEx, st);
    }
